...
const Facts = () => {
  ...
  return (
    <div className="container mx-auto px-4 mt-[12px] md:mt-[52px]">
      <div className="grid_facts gap-4">
        ...
        <div className="col-span-1">
          ...
          <p className="mt-1 text-xs text-gray-500">Рис 1. Фото</p>
        </div>
        <div className="col-span-1 h-qr h-[240px] md:h-[100px] flex items-end">
          <Image
            width={100}
            height={100}
            src="/img/QR_Code.png"
        ...
        <div className="col-span-2">
          <ul className="space-y-[18px] md:space-y-[8px] grid grid-cols-1 md:grid-cols-2">
            <li className="group flex flex-col space-y-1 hover:scale-105 hover:text-[#4C4FFF] transition-all duration-300 hover:bg-gray-100 rounded-md px-2 py-1">
              <div className="grid grid-cols-[auto_1fr] items-center pb-[12px] space-x-2">
                <ArrowUpLeft className="text-[#4C4FFF] w-8 h-8" />
              ...
              <span className="block w-full h-[0.5px] bg-gray-300" style={{ backgroundColor: "#A2A2A2" }} />
            </li>
            <li className="group flex flex-col space-y-1 hover:scale-105 hover:text-[#4C4FFF] transition-all duration-300 hover:bg-gray-100 rounded-md px-2 py-1">
              <div className="grid grid-cols-[auto_1fr] gap-x-2 items-start pb-[12px] h-16">
                <ArrowUpLeft className="text-[#4C4FFF] w-8 h-8" />
            ...
            <li className="group flex flex-col space-y-1 hover:scale-105 hover:text-[#4C4FFF] transition-all duration-300 hover:bg-gray-100 rounded-md px-2 py-1">
              <div className="grid grid-cols-[auto_1fr] items-center space-x-2 pb-[12px]">
                <ArrowUpLeft className="text-[#4C4FFF] w-8 h-8" />
                <span className="ml-[4px] text-gray-700 text-[16px] group-hover:text-[#4C4FFF]">
